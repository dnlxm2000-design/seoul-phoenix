...
export const metadata = {
  title: '선수단 2026-27',
  description: '2026-27시즌 서울피닉스FC의 선수단을 소개합니다.',
};
...
export default function Squad2026Page() {
    ...
    <div className="pt-20 bg-brand-black">
      ...
      <section className="relative py-20 lg:py-28 bg-brand-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white/60">2026-27시즌 서울피닉스FC의 선수들을 소개합니다</p>
          {/* Season Navigation */}
      ...
      {/* Note about squad updates */}
      <section className="bg-amber-50 border-b border-amber-100">
        <div className="max-w-5xl mx-auto px-4 py-3">
          <p className="text-sm text-amber-700 text-center">
            2026-27시즌 선수단은 현재 업데이트 중입니다. 선수 변동사항은 추후 반영될 예정입니다.
          </p>
        </div>
      </section>
